...
| 3  | - **Nombre:** Marcelo Binda <br> - **Edad:** 26 | Marcelo Binda gestiona el inventario de su bodega de forma manual utilizando cuadernos y en algunos casos hojas de Excel. Señala que su principal dificultad es mantener el stock actualizado, controlar los productos próximos a vencer y evitar pérdidas por falta de seguimiento en el inventario. Ha experimentado situaciones donde asumía contar con stock disponible cuando en realidad ya se había agotado, lo que generó pérdidas económicas. Actualmente realiza conteos manuales y organiza los productos según su fecha de vencimiento. Considera que una plataforma como StockWise le permitiría mejorar significativamente su gestión, especialmente mediante el registro de entradas y salidas, alertas automáticas de stock bajo o productos por vencer, y acceso a reportes de ventas, ganancias y movimientos del negocio. | ![Entrevista 3 - Dueños de bodegas](./assets/Chapter-6/entrevista-Marcelo-Binda.png) <br> <a href="https://www.youtube.com/watch?v=TU_VIDEO_ID">Validation Interview Marcelo (YouTube)</a> |
