  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <p><b>AV2:</b> Demostré responsabilidad ética al implementar pruebas de integración (Core Integration Tests) y participar en las revisiones, asegurando la calidad y confiabilidad del software entregado. Además, definí métricas analíticas y condiciones de experimentación de forma transparente para basar las decisiones del producto en datos reales y comprobables. </p>
        <p><b>TB2: </b> Demostré responsabilidad profesional al diseñar y registrar las entrevistas de validación (To-Be Validation Interviews), asegurando una recolección de datos honesta y objetiva con los usuarios. Asimismo, implementé mejoras en el código frontend para garantizar la calidad y mantenibilidad del software entregado. </p>
        ...
        <p><b>TB2: </b> Reconocí mi responsabilidad ética al documentar el flujo de aprendizaje continuo (Continuous Learning) y preparar el lanzamiento del software con un video introductorio transparente sobre las verdaderas capacidades del producto. Adicionalmente, reforcé la calidad del sistema mediante la aplicación de mejoras en el código frontend. </p>
        ...
        <p><b>AV2:</b>Reconocí mi responsabilidad profesional al establecer estándares de codificación y desarrollar las pruebas unitarias de las entidades centrales (Core Entities Unit Tests), garantizando un código limpio y mantenible. Asimismo, diseñé las entrevistas para levantar requerimientos genuinos, asumiendo un compromiso ético con las verdaderas necesidades del cliente. </p>
        <p><b>TB2: </b> Ejercí profesionalismo al realizar el análisis e interpretación objetiva de los resultados de experimentación (Experiment Aftermath & Analysis), evitando sesgos en la evaluación. También apliqué buenas prácticas al mejorar el código frontend y fomenté una cultura de equipo responsable a través de los Team Collaboration Insights. </p>
        ...
        <p><b>TB2: </b> Actué con ética profesional al implementar la evidencia tecnológica en las plataformas Web, Mobile y las APIs RESTful, asegurando que el software sea robusto y cumpla con los estándares técnicos prometidos en el ciclo de vida del producto. Además, garanticé la calidad final integrando mejoras continuas en el código frontend. </p>
        ...
        <p><b>AV2:</b> Apliqué principios éticos al asegurar la calidad y seguridad del código (Code Quality & Security), así como al implementar las pruebas integrales del sistema (Core System Tests). Con esto garanticé que los pipelines de despliegue continuo sean seguros, protegiendo la integridad de la información y previniendo fallas en producción.   </p>
        <p><b>TB2: </b> Demostré un fuerte compromiso ético al desarrollar la Matriz de Evaluación Ética y de Impacto, garantizando que el diseño y conclusiones del producto no generen consecuencias negativas inadvertidas. A la par, definí responsablemente el Product Backlog e implementé mejoras directas en el frontend. </p>
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        <p><b>AV2: </b> Emití juicios informados al planificar el seguimiento web y móvil (Web and Mobile Tracking Plan) y los componentes de notificación, evaluando cómo una comunicación oportuna optimiza la operatividad del cliente. Estas decisiones permiten que los negocios gestionen su información eficientemente, reduciendo el impacto económico por falta de datos.</p>
        <p><b>TB2: </b> Emití juicios informados al ejecutar las entrevistas de validación, lo cual me permitió entender el impacto económico y social directo de nuestra plataforma en los usuarios finales. Esta información de primera mano sirvió para orientar las mejoras del código frontend hacia una solución que realmente responda a sus realidades. </p>
        <p><b>Saldaña Ayalan, Fabiola Del Rocio</b></p>
        ...
        <p><b>TB2: </b> Consideré el impacto global y social al organizar los artefactos de las sesiones de Shareback y diseñar el material de pre-lanzamiento (Intro Video), garantizando que el valor económico y operativo de la solución sea comunicado de manera clara, realista y accesible para los negocios objetivo. </p>
        <p><b>Sanchez Rios, Camila</b></p>
        ...
        <p><b>AV2:</b> Consideré el impacto global y social de la solución al analizar el contexto actual (As-Is Summary) y definir las medidas para los experimentos. Esto me permitió diseñar propuestas tecnológicas alineadas a la realidad económica de los usuarios, garantizando que el producto resuelva problemas de su entorno de manera accesible. </p>
        <p><b>TB2: </b> Tomé decisiones basadas en evidencia al analizar los resultados de los experimentos y repriorizar el Question Backlog, considerando de qué manera la plataforma puede optimizar la economía de los usuarios. Estas métricas me permitieron enfocar las mejoras del frontend en características de alto impacto operativo. </p>
        <p><b>Choquehuanca Nuñez, Luciana Carolina</b></p>
        ...
        <p><b>TB2: </b> Evalué el impacto tecnológico y económico al desplegar las aplicaciones multiplataforma (Web, Native-Mobile y Backend) apoyadas en pipelines de experimentación, garantizando que negocios con distintos niveles de digitalización puedan acceder a la herramienta sin barreras técnicas ni costos prohibitivos. </p>
        <p><b>Fernandez Remon, Roy Linsh</b></p>
        ...
        <p><b>AV2:</b> Emití juicios informados al configurar los componentes de monitoreo, las alertas y evaluar los cálculos de escalabilidad del proyecto. Estas decisiones estructurales previenen interrupciones del servicio, evitan pérdidas financieras operativas para los clientes y optimizan el consumo de recursos computacionales de forma sostenible. </p>
        <p><b>TB2: </b> Emití juicios informados al estructurar las historias de usuario (To-Be User Stories) basándome explícitamente en los resultados de la Matriz de Evaluación Ética y de Impacto. Esto aseguró que el software se desarrolle contemplando su sostenibilidad y sus efectos positivos en el entorno social y económico de nuestros clientes.</p>
      </td>
